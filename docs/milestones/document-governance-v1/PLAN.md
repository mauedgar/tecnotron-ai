...
| **WP4** | System Guide | 3 | `FF-AI-DOC-004` | `READY` | — |
| **WP5** | Research Archive | 3 | `FF-AI-DOC-005` | `READY` | — |
...
3. Task `FF-AI-DOC-001` (TASK.md + PLAN.md) canónica, `lifecycle_status: DONE` (`2026-08-25`), aceptación Developer `2026-08-25`, integración en `tooling` (PR #10, merge `51821e2`) y `DOC_SYNC`, indexada en SoT.

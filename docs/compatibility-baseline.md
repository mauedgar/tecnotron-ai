...
| repo-packager | ejecuta con `python/.venv_tools` (uv) | funcional con gaps; no compliant v2 |
...
| Python AI Core | no oficial; `python/.venv_tools` gestionado con uv | decidir en task separada |

...
| [WP-002 Deterministic OpenCode Launchers Plan](work-packages/wp-002-deterministic-opencode-launchers/PLAN.md) | Solución técnica y descomposición aceptadas; el Developer aceptó el snapshot revisado de `TOF-W1-002` y autorizó su integración, todavía `NOT_STARTED`. |
| [Task TOF-W1-002](tasks/TOF-W1-002/TASK.md) | Contrato vigente para `WP002-WU-00` y `WP002-WU-01`; snapshot inmutable `a744d0746c50f4d411006cf99923c2f64e467797` validado, revisado con `PASS` y aceptado por el Developer. Integración `NOT_STARTED`; [RESULT](tasks/TOF-W1-002/RESULT.md) y [REVIEW](tasks/TOF-W1-002/REVIEW.md) preservan la evidencia. |

...
| [WP-002 Deterministic OpenCode Launchers Plan](work-packages/wp-002-deterministic-opencode-launchers/PLAN.md) | Solución técnica y descomposición aceptadas; el gate Developer `READY` está satisfecho y `TOF-W1-002` es el siguiente candidato, todavía sin TASK ni autoridad de implementación. |

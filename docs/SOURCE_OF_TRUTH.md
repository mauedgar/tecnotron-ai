...
| [Agent Profile Conformance](architecture/agent-profile-conformance.md) | Draft de conformance documental para perfiles mínimos; sin perfiles/adapters/runtime ejecutables y pendiente review/aceptación Developer. |
...
| [WP: Agent Profiles MVP](work-packages/agent-profiles-mvp/PLAN.md) | Follow-up post-fundación; WP activo, no parte WP1–WP6. AGENT001 `DONE`, `ACCEPTED` e `INTEGRATED`; AGENT002 `WORKING` con TASK/PLAN y conformance draft. |
...
| [Task FF-AI-AGENT-002](tasks/FF-AI-AGENT-002/TASK.md) | Conformance documental de perfiles mínimos. Validación PASS y review `ACCEPT_WITH_NON_BLOCKING_FINDINGS`; `PENDING_ACCEPTANCE`, no integrada; no modifica OpenCode, runtime ni registries. |

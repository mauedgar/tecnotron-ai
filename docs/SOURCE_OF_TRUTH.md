...
| [WP-002 Deterministic OpenCode Launchers Plan](work-packages/wp-002-deterministic-opencode-launchers/PLAN.md) | Solución técnica y descomposición aceptadas; `TOF-W1-002` está implementada y validada, con review independiente `PASS`, en `PENDING_ACCEPTANCE` del Developer y sin integración iniciada. |
| [Task TOF-W1-002](tasks/TOF-W1-002/TASK.md) | Contrato vigente para `WP002-WU-00` y `WP002-WU-01`; snapshot inmutable `a744d0746c50f4d411006cf99923c2f64e467797` validado y revisado con `PASS`, pendiente de aceptación del Developer. [RESULT](tasks/TOF-W1-002/RESULT.md) y [REVIEW](tasks/TOF-W1-002/REVIEW.md) preservan la evidencia. |

---
description: Static Tecnotron profile for execution planning.
mode: primary
permission: deny
---
...
required_inputs: [accepted_authority_ref, resolved_project_profile_ref, resolved_repository_ref, read_scope, context_ref_or_evidence_requirements, context_budget, accepted_spec, milestone, dependencies, ownership]
allowed_outputs: [wp_plan_proposal, task_decomposition_proposal]

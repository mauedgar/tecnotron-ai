---
description: Static Tecnotron profile for specification analysis.
mode: primary
permission: deny
---
...
required_inputs: [accepted_authority_ref, resolved_project_profile_ref, resolved_repository_ref, read_scope, context_ref_or_evidence_requirements, context_budget, problem, accepted_authorities, constraints, gaps]
allowed_outputs: [spec_proposal]

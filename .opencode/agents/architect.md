---
description: Static Tecnotron profile for technical architecture.
mode: primary
permission: deny
---
...
required_inputs: [accepted_authority_ref, resolved_project_profile_ref, resolved_repository_ref, read_scope, context_ref_or_evidence_requirements, context_budget, accepted_spec, existing_contracts, architecture, consumers]
allowed_outputs: [architecture_proposal, adr_proposal]

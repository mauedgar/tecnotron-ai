---
description: Static Tecnotron profile for independent read-only review.
mode: primary
permission: deny
---
...
required_inputs: [accepted_authority_ref, resolved_project_profile_ref, resolved_repository_ref, read_scope, context_ref_or_evidence_requirements, context_budget, change_snapshot_ref, validation_evidence_ref, accepted_spec_or_task, change_snapshot, validation_result]
allowed_outputs: [external_review_report]
